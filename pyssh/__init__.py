...
class Ssh:
    ...
    def read_until(self, match, timeout=None):
        ...
        """
        if self.isopen:
            return self.sshout.read_until(match, timeout)
        else:
            return self.sshout.read_lazy()    
    ...
    def sendcmd(self, cmd, readtype=READ_SOME, expected=None, timeout=None):
        ...
        elif readtype == READ_UNTIL and expected is not None:
